...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>设备数量信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertEquipment" lay-filter="demoForm" id="" name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">数量ID</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etId" name="etId" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['equipment'].etId}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">数量编码</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etCode" name="etCode" lay-verify="required" autocomplete="off" value="${message['equipment'].etCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <input type="text" class="layui-input" id="etDate" name="etDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['equipment'].etDate}">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etName" name="etName" lay-verify="required" autocomplete="off" value="${message['equipment'].etName}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">计量单位</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etUnit" name="etUnit" lay-verify="required" autocomplete="off" value="${message['equipment'].etUnit}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etDoDesign" name="etDoDesign" lay-verify="required|number" autocomplete="off" value="${message['equipment'].etDoDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">已完变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etDoChange" name="etDoChange" lay-verify="number" autocomplete="off" value="${message['equipment'].etDoChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etUpDesign" name="etUpDesign" lay-verify="required|number" autocomplete="off" value="${message['equipment'].etUpDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对上计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etUpChange" name="etUpChange" lay-verify="number" autocomplete="off" value="${message['equipment'].etUpChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etDownDesign" name="etDownDesign" lay-verify="required|number" autocomplete="off" value="${message['equipment'].etDownDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对下计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="etDownChange" name="etDownChange" lay-verify="number" autocomplete="off" value="${message['equipment'].etDownChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="etInfo" name="etInfo" placeholder="请输入内容" value="${message['equipment'].etInfo}"></textarea>
    </div>
  </div>
