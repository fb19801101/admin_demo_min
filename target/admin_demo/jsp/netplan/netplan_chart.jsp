...
<head>
    ...
    <link rel=stylesheet href="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/platform.css" type="text/css">
    <link rel=stylesheet href="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/dateField/jquery.dateField.css" type="text/css">

    <link rel=stylesheet href="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/gantt.css" type="text/css">
    <link rel=stylesheet href="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttPrint.css" type="text/css" media="print">
    <link rel=stylesheet href="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/valueSlider/mb.slider.css" type="text/css" media="print">
...
<script src="${pageContext.request.contextPath}/res/js/jquery-ui-1.12.1/jquery-ui.js"></script>

<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/jquery.livequery.1.1.1.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/jquery.timers.js"></script>

<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/utilities.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/forms.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/date.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/dialogs.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/layout.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/i18nJs.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/dateField/jquery.dateField.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/JST/jquery.JST.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/valueSlider/jquery.mb.slider.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/svg/jquery.svg.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/libs/jquery/svg/jquery.svgdom.1.8.js"></script>

<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttUtilities.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttTask.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttDrawerSVG.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttZoom.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttGridEditor.js"></script>
<script src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/ganttMaster.js"></script>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        // TODO: here starts gantt initialization
        ge = new GanttMaster();
        ...
        // TODO: in order to force compute the best-fitting zoom level
        delete ge.gantt.zoom;

        loadGanttFromServer();

        // TODO: fill default Teamwork roles if any
        if (!ge.roles || ge.roles.length == 0) {
            setRoles();
        }

        // TODO: fill default Resources roles if any
    ...
    function loadGanttFromServer(taskId, callback) {
        ...
        // TODO: this is a simulation: load data from the local storage if you have already played with the demo or a textarea with starting demo data
        loadFromAjaxStorage();
    ...
    function saveGanttOnServer() {
        // TODO: this is a simulation: save data to the local storage or to the textarea
        saveInLocalStorage();
    ...
    // TODO: Get project file as JSON (used for migrate project from gantt to Teamwork)
    function getFile() {
    ...
    // TODO: LOCAL STORAGE MANAGEMENT (for this demo only)
    ...
    function loadFromAjaxStorage() {
        ...
        // TODO: if not found create a new example task
        if (!ret || !ret.tasks || ret.tasks.length == 0){
            $.ajax({
                type: 'post',
                url: '${pageContext.request.contextPath}/netplan/chartNetPlanBody',
                data : {page:$("#page").val(),limit : $("#limit").val(),level : $("#level").val()},
                dataType: 'json',
    ...
    // TODO: Open a black popup for managing resources. This is only an axample of implementation (usually resources come from server)
    ...
    function editResources() {
        ...
        // TODO: bind add resource
        resourceEditor.find("#addResource").click(function(){
            resTbl.append($.JST.createFromTemplate({id:"new",name:"resource"}, "RESOURCE_ROW"))
        });

        // TODO: bind save event
        resourceEditor.find("#resSaveButton").click(function(){
            var newRes=[];

            // TODO: find for deleted res
            for (var i=0;i<ge.resources.length;i++){
                var res=ge.resources[i];
                var row = resourceEditor.find("[resId="+res.id+"]");
                if (row.length>0){
                    // TODO: if still there save it
    ...
    function initializeHistoryManagement(taskId){
        // TODO: retrieve from server the list of history points in millisecond that represent the instant when the data has been recorded
                    ...
                    if (!ge.element.is(".historyOn")) {
                        ...
                        $.getJSON(contextPath + "/applications/teamwork/task/taskAjaxController.jsp", {CM: "GETGANTTHISTPOINTS", OBJID: ge.tasks[0].id}, function (response) {
                            ...
                            if (response.ok == true) {
                                ...
                                if (dh && dh.length > 0) {
                                    // TODO: si crea il div per lo slider
    ...
    function showBaselineInfo (event,element){
        // TODO: alert(element.attr("data-label"));
...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
      <a href="https://gantt.twproject.com/"><img src="${pageContext.request.contextPath}/res/js/jQueryGantt-6.3.3/res/twGanttLogo.png" alt="Twproject" align="absmiddle" style="max-width: 136px; padding-right: 15px"></a>
    ...
    <button onclick='newProject();' class='button requireWrite newproject'><em>new project</em></button>
    &nbsp; &nbsp;

    page <input type="text" id="page" value="1" style="width:35px">
    limit <input type="text" id="limit" value="20" style="width:35px">
    level <input type="text" id="level" value="4" style="width:35px">
    &nbsp; &nbsp;

    <button onclick='loadFromLocalStorage();' class='button requireWrite initDemoProject'><em>init</em></button>
    <button onclick='loadFromAjaxStorage();' class='button requireWrite getFile'><em>async</em></button>
...
<script type="text/javascript">
    ...
    function createNewResource(el) {
        ...
        openBlackPopup(url, 700, 320, function (response) {
            // TODO: fillare lo smart combo
            if (response && response.resId && response.resName) {
                // TODO: fillare lo smart combo e chiudere l'editor
