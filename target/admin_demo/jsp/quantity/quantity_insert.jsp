...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>工程数量信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertQuantity" lay-filter="demoForm" id=""  name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">数量ID</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyId"  name="qyId" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['quantity'].qyId}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">数量编码</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyCode"  name="qyCode" lay-verify="required" autocomplete="off" value="${message['quantity'].qyCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <input type="text" class="layui-input" id="qyDate" name="qyDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['quantity'].qyDate}">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyName"  name="qyName" lay-verify="required" autocomplete="off" value="${message['quantity'].qyName}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">计量单位</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyUnit"  name="qyUnit" lay-verify="required" autocomplete="off" value="${message['quantity'].qyUnit}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyDoDesign"  name="qyDoDesign" lay-verify="required|number" autocomplete="off" value="${message['quantity'].qyDoDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">已完变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyDoChange"  name="qyDoChange" lay-verify="number" autocomplete="off" value="${message['quantity'].qyDoChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyUpDesign"  name="qyUpDesign" lay-verify="required|number" autocomplete="off" value="${message['quantity'].qyUpDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对上计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyUpChange"  name="qyUpChange" lay-verify="number" autocomplete="off" value="${message['quantity'].qyUpChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyDownDesign"  name="qyDownDesign" lay-verify="required|number" autocomplete="off" value="${message['quantity'].qyDownDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对下计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="qyDownChange"  name="qyDownChange" lay-verify="number" autocomplete="off" value="${message['quantity'].qyDownChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="qyInfo"  name="qyInfo" placeholder="请输入内容" value="${message['quantity'].qyInfo}"></textarea>
    </div>
  </div>
