...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>征拆数量信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertDemolition" lay-filter="demoForm" id="" name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">数量ID</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnId" name="dnId" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['demolition'].dnId}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">数量编码</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnCode" name="dnCode" lay-verify="required" autocomplete="off" value="${message['demolition'].dnCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <input type="text" class="layui-input" id="dnDate" name="dnDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['demolition'].dnDate}">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnName" name="dnName" lay-verify="required" autocomplete="off" value="${message['demolition'].dnName}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">计量单位</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnUnit" name="dnUnit" lay-verify="required" autocomplete="off" value="${message['demolition'].dnUnit}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnDoDesign" name="dnDoDesign" lay-verify="required|number" autocomplete="off" value="${message['demolition'].dnDoDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">已完变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnDoChange" name="dnDoChange" lay-verify="number" autocomplete="off" value="${message['demolition'].dnDoChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnUpDesign" name="dnUpDesign" lay-verify="required|number" autocomplete="off" value="${message['demolition'].dnUpDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对上计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnUpChange" name="dnUpChange" lay-verify="number" autocomplete="off" value="${message['demolition'].dnUpChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnDownDesign" name="dnDownDesign" lay-verify="required|number" autocomplete="off" value="${message['demolition'].dnDownDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对下计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="dnDownChange" name="dnDownChange" lay-verify="number" autocomplete="off" value="${message['demolition'].dnDownChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="dnInfo" name="dnInfo" placeholder="请输入内容" value="${message['demolition'].dnInfo}"></textarea>
    </div>
  </div>
...
<script>
    layui.config({
        ...
        dtree.render({
            ...
            ,dataStyle: "layuiStyle"  //使用layui风格的数据格式
            ,dataFormat: "list"  //配置data的风格为list
            ,url: "${pageContext.request.contextPath}/costlayer/toCostLayerTreeBody" // 使用url加载（可与data加载同时存在）
            ,initLevel: 1
            ,selectTips: "单选数据示例"
            ,menubar: true //开启菜单栏
            ,checkbar: false  //开启复选框
