...
public interface EquipmentMapper extends MyBatisBaseMapper<Equipment, Integer, EquipmentExample> {
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Equipment> _selectByJoinPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</if>" +
            "</script>")
    List<Equipment> selectByJoinPiId(@Param("piId") Integer piId, @Param("offset") Integer offset, @Param("limit") Integer limit);

    @Select("<script>\n"+
            "select count(*) from tb_equipment et\n" +
            "right join tb_partitem pi on pi.pi_id = et.pi_id\n" +
            "<where>\n" +
            "  <if test=\"_parameter != null and _parameter.containsKey('piId') and piId != null\">\n" +
            "    pi.pi_id = #{piId}\n" +
            "  </if>\n" +
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Equipment> _queryByJoinPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</if>" +
            "</script>")
    List<Equipment> queryByJoinPiId(@Param("piId") Integer piId, @Param("offset") Integer offset, @Param("limit") Integer limit);
