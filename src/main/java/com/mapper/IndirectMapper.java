 ...
 */
@Repository
public interface IndirectMapper extends MyBatisBaseMapper<Indirect, Integer, IndirectExample> {
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> selectByPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> selectByClId(@Param("clId") Integer clId);
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> queryByPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> queryByClId(@Param("clId") Integer clId);
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> _selectByJoinPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</if>" +
            "</script>")
    List<Indirect> selectByJoinPiId(@Param("piId") Integer piId, @Param("offset") Integer offset, @Param("limit") Integer limit);
    ...
    @Select("<script>\n"+
            ...
            "</where>\n" +
            "</script>")
    List<Indirect> _queryByJoinPiId(@Param("piId") Integer piId);
    ...
    @Select("<script>\n"+
            ...
            "</if>" +
            "</script>")
    List<Indirect> queryByJoinPiId(@Param("piId") Integer piId, @Param("offset") Integer offset, @Param("limit") Integer limit);
