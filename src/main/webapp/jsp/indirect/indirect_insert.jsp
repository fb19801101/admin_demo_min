...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>间接数量信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertIndirect" lay-filter="demoForm" id="" name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">数量ID</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itId" name="itId" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['indirect'].itId}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">数量编码</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itCode" name="itCode" lay-verify="required" autocomplete="off" value="${message['indirect'].itCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <input type="text" class="layui-input" id="itDate" name="itDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['indirect'].itDate}">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itName" name="itName" lay-verify="required" autocomplete="off" value="${message['indirect'].itName}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">计量单位</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itUnit" name="itUnit" lay-verify="required" autocomplete="off" value="${message['indirect'].itUnit}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itDoDesign" name="itDoDesign" lay-verify="required|number" autocomplete="off" value="${message['indirect'].itDoDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">已完变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itDoChange" name="itDoChange" lay-verify="number" autocomplete="off" value="${message['indirect'].itDoChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itUpDesign" name="itUpDesign" lay-verify="required|number" autocomplete="off" value="${message['indirect'].itUpDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对上计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itUpChange" name="itUpChange" lay-verify="number" autocomplete="off" value="${message['indirect'].itUpChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itDownDesign" name="itDownDesign" lay-verify="required|number" autocomplete="off" value="${message['indirect'].itDownDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对下计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="itDownChange" name="itDownChange" lay-verify="number" autocomplete="off" value="${message['indirect'].itDownChange}">
      </div>
    </div>
  </div>
