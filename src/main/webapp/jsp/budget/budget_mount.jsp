...
<script>
    ...
    layui.use('table', function(){
        var table = layui.table; //Budget表格
        ...
        table.render({
            ...
            ,totalRow: true //开启合计行
            ,url: '${pageContext.request.contextPath}/budget/mountBudgetBody' // 使用url加载（可与data加载同时存在）
            ,cellMinWidth: 100
            ,event: true
            ,cols: [[{type:'numbers', title:'序号', fixed: true}
                ,{field:'bgId', title:'概算ID', width:100, sort: true, fixed: true, totalRowText: '金额合计'}
                ,{field:'bgCode', title: '概算编码', minWidth:100, sort: true}
