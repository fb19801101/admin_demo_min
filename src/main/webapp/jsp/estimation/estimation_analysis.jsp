...
<script>
    layui.config({
        ...
        var table_ins = dtable.render({
            ...
            ,url: '${pageContext.request.contextPath}/estimation/analysisEstimationBody'
            ,toolbar: '#toolbar'
            ...
            ,cols: [[{type: 'numbers'},{type: 'checkbox'}
                ...
                ,{field:'enId', title:'概算ID', width:100, sort: true, fixed: true}
                ,{field:'clCode', title:'成本层编码'}
                ,{field:'clType', title:'成本层类型'}
                ,{field:'clName', title:'成本层名称'}
                ,{field:'gdCode', title:'指导价编码'}
                ,{field:'gdName', title:'指导价名称'}
                ,{field:'gdPrice', title:'指导价单价'}
                ,{field:'gdMoney', title:'指导价合价'}
                ,{field:'enUnit', title:'计量单位'}
                ,{field:'clBudget', title:'概算数量'}
                ...
                ,{field:'gdActMoney', title:'现场设计金额'}
                ,{field:'gdDoMoney', title:'现场实际金额'}
                ,{field:'gdUpMoney', title:'对上计价金额'}
                ,{field:'gdDownMoney', title:'对下计价金额'}
                ,{field:'enQtyLabour', title:'劳务数量'}
                ,{field:'enPriceLabour', title:'劳务单价'}
                ,{field:'enMoneyLabour', title:'劳务合价'}
