...
<script>
    layui.config({
        ...
        var table_ins = dtable.render({
            ...
            ,where: { field: 'ct_id', value: null, level: 5, page: 1, limit: 20}
            ,url: '${pageContext.request.contextPath}/contract/toContractBody'
            ,toolbar: '#toolbar'
            ,defaultToolbar: ['filter', 'print', 'exports']
            ,event: true
            ,cols: [[{type: 'numbers'},{type: 'checkbox'}
                ,{field: 'ctName', title: '菜单名称', minWidth: 400}
        ...
        laypage.render({
          ...
          ,jump: function(obj){
            table_ins.reload({//重载表格
              where: { field: 'ct_id', value: null, level: 5, page: obj.curr, limit: obj.limit}
            })
          }
        });
