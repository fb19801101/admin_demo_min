...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>劳务数量信息添加</legend>
</fieldset>

<form class="layui-form" method="POST" action="insertLabour" lay-filter="demoForm" id="" name="myform" onSubmit="return checkGuidance(myform)">
  <div class="layui-form-item">
    <div class="layui-inline">
      <label class="layui-form-label">数量ID</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbId" name="lbId" lay-verify="number" placeholder="可以为空，系统默认自增！" autocomplete="off" value="${message['labour'].lbId}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">数量编码</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbCode" name="lbCode" lay-verify="required" autocomplete="off" value="${message['labour'].lbCode}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <input type="text" class="layui-input" id="lbDate" name="lbDate" lay-verify="required" placeholder="yyyy-MM-dd" autocomplete="off" value="${message['labour'].lbDate}">
    </div>
</div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbName" name="lbName" lay-verify="required" autocomplete="off" value="${message['labour'].lbName}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">计量单位</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbUnit" name="lbUnit" lay-verify="required" autocomplete="off" value="${message['labour'].lbUnit}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbDoDesign" name="lbDoDesign" lay-verify="required|number" autocomplete="off" value="${message['labour'].lbDoDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">已完变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbDoChange" name="lbDoChange" lay-verify="number" autocomplete="off" value="${message['labour'].lbDoChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbUpDesign" name="lbUpDesign" lay-verify="required|number" autocomplete="off" value="${message['labour'].lbUpDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对上计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbUpChange" name="lbUpChange" lay-verify="number" autocomplete="off" value="${message['labour'].lbUpChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbDownDesign" name="lbDownDesign" lay-verify="required|number" autocomplete="off" value="${message['labour'].lbDownDesign}">
      </div>
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">对下计价变更数量</label>
      <div class="layui-input-inline">
        <input type="text" class="layui-input" id="lbDownChange" name="lbDownChange" lay-verify="number" autocomplete="off" value="${message['labour'].lbDownChange}">
      </div>
    </div>
  </div>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-inline" style="width: 515px">
      <textarea class="layui-textarea" id="lbInfo" name="lbInfo" placeholder="请输入内容" value="${message['labour'].lbInfo}"></textarea>
    </div>
  </div>
